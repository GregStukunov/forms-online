  ...
  return (
    <div className="relative rounded-lg border-t bg-white px-8 pb-6 shadow">
      ...
      <div className="space-y-2 pt-4 pb-8">
        {/* title  */}
        <input
          className="w-full border-b border-white bg-white py-3 text-xl hover:border-gray-300 focus:border-b-2 focus:border-orange-700"
        ...
        {data.withDescription && (
          <textarea
            className="h-20 w-full resize-y border-b border-white bg-white text-sm hover:border-gray-300 focus:border-b-2 focus:border-orange-700"
            disabled={!hasEditAccess}
            name="desc"
            onChange={(e) =>
